...
export type Deployment = {
    ...
    provider: Address; // address of the validator node provider smart contract
...
export default class Deploy extends DeployBaseCommand<typeof Deploy> {
    ...
    static flags = {
        ...
        provider: CustomFlags.address({
            summary: "address of node provider",
            description:
                "A validator node provider is already associated with a consensus and a payment method",
        }),
        webapp: Flags.url({
