...
running command...
$ sunodo (--version)
@sunodo/cli/0.8.0 linux-x64 node-v20.6.0
$ sunodo --help [COMMAND]
USAGE
  $ sunodo COMMAND
...
...
_See code: [dist/commands/address-book.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/address-book.ts)_
...
_See code: [dist/commands/build.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/build.ts)_
...
_See code: [dist/commands/clean.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/clean.ts)_
...
```
USAGE
  $ sunodo create NAME --template cpp|cpp-low-level|go|javascript|lua|python|ruby|rust|typescript [--branch
    <value>]
...
FLAGS
  ...
  --template=<option>  (required) template name to use
                       <options: cpp|cpp-low-level|go|javascript|lua|python|ruby|rust|typescript>
...
_See code: [dist/commands/create.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/create.ts)_
...
_See code: [dist/commands/doctor.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/doctor.ts)_
...
```
USAGE
  $ sunodo run [--block-time <value>] [--epoch-duration <value>] [--no-backend] [-v]
...
FLAG DESCRIPTIONS
  --no-backend  run a node without the application code
    ...
    Run a node without the application code. Application must be executed by the developer on the host machine, fetching
    inputs from the node running at http://localhost:5004
```

_See code: [dist/commands/run.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/run.ts)_
...
_See code: [dist/commands/send/index.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/send/index.ts)_
...
_See code: [dist/commands/send/dapp-address.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/send/dapp-address.ts)_
...
_See code: [dist/commands/send/erc20.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/send/erc20.ts)_
...
_See code: [dist/commands/send/erc721.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/send/erc721.ts)_
...
_See code: [dist/commands/send/ether.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/send/ether.ts)_
...
_See code: [dist/commands/send/generic.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/send/generic.ts)_
...
_See code: [dist/commands/shell.ts](https://github.com/sunodo/sunodo/blob/v0.8.0/dist/commands/shell.ts)_
